...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        {{-- Favicon --}}
        <link rel="icon" href="{{ asset('img/favicon.png.png') }}" type="image/png" sizes="16x16">
                        ...
                        @switch($course->status)
                            ...
                            @case(2)
                                <div class="card text-gray-500">
                                    <div class="card-body bg-yellow-200">Este curso se encuentra en revision.</div>
                                </div>
                                @break

                            @case(3)
                                <div class="card text-gray-500">
                                    <div class="card-body bg-green-200">Este curso se encuentra publicado.</div>
                                </div>
                                @break
